...
class JobUpdateScreen extends StatefulWidget {
  ...
  const JobUpdateScreen(this.IT_or_nonIT, {Key? key}) : super(key: key);

  @override
  State<JobUpdateScreen> createState() => _JobUpdateScreenState(IT_or_nonIT);
}

class _JobUpdateScreenState extends State<JobUpdateScreen> {
  final String It_or_nonIT;
  late bool accessToken = false;
  _JobUpdateScreenState(this.It_or_nonIT);
  ...
  CollectionReference get _product =>
      FirebaseFirestore.instance.collection("${It_or_nonIT}JobUpdates");
